        ...
        return (
          <div key={id}>
            <div className="xl:hidden">
              ...
              <div className={`${id === parseInt(shown) ? "" : "hidden"}`}>
                <Image
                  ...
                  className="w-full "
                />
                <p className="mb-12 text-xl leading-tighter mt-2.5 lg:mb-0">
                  {subtitle}
                </p>
              </div>
            </div>
            ...
            <div className="hidden overflow-hidden xl:flex group">
              <h3
                id={id}
                className={`relative transition-all duration-500 cursor-pointer text-5.5xl leading-2 group after:opacity-0 after:transition-all after:duration-500 after:bg-black after:w-full after:h-0.1 after:absolute after:bottom-0 after:-left-full group-hover:after:left-0 group-hover:after:opacity-100`}
